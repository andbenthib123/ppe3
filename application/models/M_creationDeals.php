...
public function getAllDemandes()
    ...
    {
    $query=$this->db->query("SELECT offre.descriptionOffre, user.nomUser,user.idUser from user,offre WHERE offre.idUser=user.idUser and offre.descriptionOffre like '%".$txtRecherche."%'");
return $query->result();   
}
